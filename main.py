...
st.write("""
    This app predicts Parkinson’s Disease based on your symptoms. Answer the following questions and the app will give predictions:
...
cognitive_val = 1 if cognitive_input == "Yes" else 0
